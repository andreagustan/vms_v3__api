...
{
    public class T_POServices : IT_PO
    {
        ...
        public T_POServices(IRepository _repository, IMapper _mapper, ILogger<Logs> _logger, IHelpers _helpers, IAppsLog _appsLog)
        {
        ...
        public async Task<(bool Status, object Result, string Message)> ListObject(ListPageExt Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_PO_View", p);
        ...
        public async Task<(bool Status, object Result, string Message)> ListDetailObject(ListPageExt Items)
        {
            try
            {
                var p = new DynamicParameters();
                ...
                var Rs = await repository.executeProcedure<object>("pT_PODetail_View", p);
        ...
        public async Task<(bool Status, RsList Result, string Message)> ListDetailObjectExt(ListPageExt Items)
        {
            try
            {
                var p = new DynamicParameters();
        ...
        public async Task<(bool Status, object Result, string Message)> BulkUpdate(T_PO Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_PO_Bulk", p);
