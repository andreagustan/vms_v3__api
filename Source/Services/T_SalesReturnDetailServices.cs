...
{
    public class T_SalesReturnDetailServices : IT_SalesReturnDetail
    {
        ...
        public T_SalesReturnDetailServices(IRepository _repository, IMapper _mapper, ILogger<Logs> _logger, IHelpers _helpers, IAppsLog _appsLog)
        {
        ...
        public async Task<(bool Status, object Result, string Message)> ListObject(ListPageExt Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_SalesReturnDetail_View", p);
        ...
        public async Task<(bool Status, object Result, string Message)> DeleteById(CommonDelete Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_SalesReturnDetail_Del", p);
