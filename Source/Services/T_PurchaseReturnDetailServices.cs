...
{
    public class T_PurchaseReturnDetailServices : IT_PurchaseReturnDetail
    {
        ...
        public T_PurchaseReturnDetailServices(IRepository _repository, IMapper _mapper, ILogger<Logs> _logger, IHelpers _helpers, IAppsLog _appsLog)
        {
        ...
        public async Task<(bool Status, object Result, string Message)> ListObject(ListPageExt Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_PurchaseReturnDetail_View", p);
        ...
        public async Task<(bool Status, object Result, string Message)> DeleteById(CommonDelete Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_PurchaseReturnDetail_Del", p);
