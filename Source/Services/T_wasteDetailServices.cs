...
{
    public class T_wasteDetailServices : IT_wasteDetail
    {
        ...
        public T_wasteDetailServices(IRepository _repository, IMapper _mapper, ILogger<Logs> _logger, IHelpers _helpers, IAppsLog _appsLog)
        {
        ...
        public async Task<(bool Status, object Result, string Message)> ListObject(ListPageExt Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_WasteDetail_View", p);
        ...
        public async Task<(bool Status, object Result, string Message)> DeleteById(CommonDelete Items)
        {
            try
            {
                ...
                var Rs = await repository.executeProcedure<object>("pT_WasteDetail_Del", p);
