...
{
    public partial class T_DoDetailController : BaseApiController
    {
        ...
        private readonly IDoDetail _DoDetail;

        public T_DoDetailController(IRepository repository, IMapper mapper, IAppsLog appsLog, IHelpers helpers, ISoapSSO soapSSOws, IDoDetail DoDetail)
        {
        ...
        public async Task<IActionResult> GetListPage([FromQuery] ListPageExt Items)
        {
            ...
            try
            {
                ...
                DtLog.Description = "pT_DODetail_View";
                ...
                var Rs = await _DoDetail.ListObjectExt(Items);
                if (Rs.Status)
                {
