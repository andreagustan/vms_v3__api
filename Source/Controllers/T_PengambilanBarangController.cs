...
{
    public partial class T_PengambilanBarangController : BaseApiController
    {
        ...
        private readonly IT_PengambilanBarang _T_PengambilanBarang;

        public T_PengambilanBarangController(IRepository repository, IMapper mapper, IAppsLog appsLog, IHelpers helpers, ISoapSSO soapSSOws
		, IT_PengambilanBarang T_PengambilanBarang)
        {
            ...
            _soapSSOws = soapSSOws;
            _T_PengambilanBarang = T_PengambilanBarang;
        }
        ...
        public async Task<IActionResult> GetListPage([FromQuery] ListPageExt Items)
        {
            ...
            try
            {
                ...
                var Rs = await _T_PengambilanBarang.ListObjectExt(Items);
                if (Rs.Status)
                {
