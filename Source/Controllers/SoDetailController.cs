...
{
    public partial class T_SoDetailController : BaseApiController
    {
        ...
        private readonly ISoDetail _SoDetail;

        public T_SoDetailController(IRepository repository, IMapper mapper, IAppsLog appsLog, IHelpers helpers, ISoapSSO soapSSOws, ISoDetail SoDetail)
        {
